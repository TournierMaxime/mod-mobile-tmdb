...
interface DetailsSerieProps {
  i18n: any
  t: any
  navigation: NavigationProp<SerieStackParamList, "DetailsSerie">
  route: any
}

const DetailsSerie = ({ route }: DetailsSerieProps) => {
            ...
            <View style={backDropPoster()}>
              ...
              >
                <Text style={mediaTitle()}>
                  ...
                  {" • "}
                  {Series.genres({ data: serie })}
                  {" • "}
                  {Series.creators({ data: serie })}
                </Text>
              </View>
            </View>
            <Tabs
