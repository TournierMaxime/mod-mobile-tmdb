...
interface DetailsPeopleProps {
  i18n: any
  t: any
  navigation: NavigationProp<MovieStackParamList, "DetailsPeople">
  route: any
}

const DetailsPeople: React.FC<DetailsPeopleProps> = ({
  route,
}: DetailsPeopleProps) => {
